 ...
 * IDL can be found at `target/idl/confidential_perps.json`.
 */
export type ConfidentialPerps = {
  "address": "EhTFnsoyZp9aRYoZrFPVPtokiRLwjxvAgZAuEQG8yZgF",
  "metadata": {
    "name": "confidentialPerps",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "userCollateral2",
          "writable": true
        },
        {
          "name": "userCollateral3",
          "writable": true
        }
      ],
      "args": [
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "rateLimitVaultSnapshot",
            "type": "u64"
          },
          {
            "name": "rateLimitWithdrawn",
            "type": "u64"
          }
        ]
      }
